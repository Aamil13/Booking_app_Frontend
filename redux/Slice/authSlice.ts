...
const initialState ={
    ...
    AuthError: null,
    // @ts-ignore
    AuthUser:  typeof window !== "undefined" ? JSON.parse(localStorage.getItem("BookingUser") || "null" ) : null
} as authState
...
const AuthSlice = createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        builder.addCase(login.fulfilled,(state,action)=>{
            ...
            localStorage.setItem("BookingUser",JSON.stringify(action.payload.otherDetails))
        ...
        builder.addCase(login.rejected,(state,action:PayloadAction<any>)=>{
            ...
            state.AuthError = action.payload.response.data.message
        })
    }
})
