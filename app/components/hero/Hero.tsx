  ...
  return (
    <div className='flex h-[500px] max-sm:h-96 justify-center relative'>
        <div  className='w-11/12 relative flex justify-start '>
            ...
            <p className='bg-transparent text-white max-w-xs max-sm:text-sm'>Where your journey to find the best hotel ends. And your exciting adventure of exploring new land begins.</p>
            </div>
        </div>
        <HeroFilter/>
    </div>
