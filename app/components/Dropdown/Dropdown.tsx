...
const Dropdown = (props: Props) => {
  ...
  return (
    <motion.div  className='max-sm:block hidden relative z-10 '>
            ...
            {
                show && 
                <motion.div className="absolute  -right-6 bg-white p-2 shadow-lg "
                       ...
                       >
                        {
                          auth?.username ?
                            <>
                             <p onClick={()=>router.push("/bookings")} className='bg-inherit cursor-pointer hover:text-green-300 transition-all duration-150'>Bookings</p>
                    <p  onClick={()=>dispatch(LogOut())} className='bg-inherit cursor-pointer hover:text-green-300 transition-all duration-150'>Log-Out</p>
                            </>
                          :
                          <>
